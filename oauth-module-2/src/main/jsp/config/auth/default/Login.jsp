  ...
  <table border="0" cellpadding="0" cellspacing="0" align="center" title="">
	...
	<!-- custom auth methods -->
        <tr>
            <td>
	        <%
                     String authServiceUrl = org.forgerock.openam.OAuthConf.newInstance(request, "OAuth")
                        .getAuthServiceUrl(request);
                %>
		<a href="<%= authServiceUrl %>">
                    <image alt="FB icon here" src="<%= ServiceURI %>/images/fbook.png" height="50px" width="50px">
                </a>
            </td>
        </tr>	
	<!-- end of custom auth methods -->
