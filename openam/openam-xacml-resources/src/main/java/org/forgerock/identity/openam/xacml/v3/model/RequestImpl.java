...
public abstract class RequestImpl implements RequestAbstract {
     ...
     * @throws com.sun.identity.saml2.common.SAML2Exception if the object is immutable.
     * @see #getIssuer
     */
     ...
     * @see #setIssuer(com.sun.identity.saml2.assertion.Issuer)
     */
     ...
     * @throws com.sun.identity.saml2.common.SAML2Exception if it could not sign the Request.
     */
     ...
     * @see #setExtensions(com.sun.identity.saml2.protocol.Extensions)
     */
     ...
     * @throws com.sun.identity.saml2.common.SAML2Exception if the signature could not be verified
     */
     ...
     * @throws com.sun.identity.saml2.common.SAML2Exception if it could not create String object
     */
   ...
   /* Validates the required elements in the SAML Request. */
    ...
    /**
     * Parses the Document Element for this object.
     *
     * @param element the Document Element of this object.
     * @throws com.sun.identity.saml2.common.SAML2Exception if error parsing the Document Element.
     */
    ...
    /**
     * Parses attributes of the Document Element for this object.
     *
     * @param element the Document Element of this object.
     * @throws com.sun.identity.saml2.common.SAML2Exception if error parsing the Document Element.
     */
     ...
     * @throws com.sun.identity.saml2.common.SAML2Exception if error parsing the Document Element.
     */
    protected void parseDOMChildElements(ListIterator iter)
        throws SAML2Exception {
