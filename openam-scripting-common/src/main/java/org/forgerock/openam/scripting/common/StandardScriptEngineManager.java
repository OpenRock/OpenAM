...
import org.forgerock.openam.scripting.common.timeouts.ObservedContextFactory;
...
public final class StandardScriptEngineManager extends ScriptEngineManager {
    ...
    public StandardScriptEngineManager() {
        ...
        registerEngineName(JavascriptScriptingLanguage.JAVASCRIPT_ENGINE_NAME, rhino);
        registerEngineName(GroovyScriptingLanguage.GROOVY_ENGINE_NAME, groovy);
