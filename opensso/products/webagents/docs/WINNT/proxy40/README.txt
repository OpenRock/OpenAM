...
2.5.6 cp <webserver-install-dir>/include/* <openam_webagent>/extlib/WINNT/proxy/include
2.5.7 The following is applicable for Windows only. 
cp <webserver-install-dir>/lib/ns-httpd40.dll <openam_webagent>/extlib/WINNT/proxy/lib
