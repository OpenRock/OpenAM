...
public class JMQTokenRepo extends GeneralTaskRunnable implements JsonResource {
    ...
    // Grace period before expired session records are removed from the repository
