...
public interface ClientVerifier {
    ...
    /**
     * Authenticates the client and use the {@link org.restlet.engine.header.HeaderConstants#HEADER_AUTHORIZATION}
     * <p/>
     * TODO Implement verify(Request request, Response response) instead
     *
     * @param challengeResponse from the HTTP Request
     ...
     * When using other authentication methods, the authorization server MUST define a mapping between the client
     * identifier (registration record) and authentication scheme.
     *
     * @param client_id
     * @return
     */
