...
/**
 * @see <a href="http://tools.ietf.org/html/draft-ietf-oauth-v2-http-mac">HTTP Authentication: MAC Access Authentication</a>
 */
    ...
    public void parseResponse(ChallengeResponse challenge, Request request, Series<Header> httpHeaders) {
        try {
            ...
            getLogger().log(Level.INFO,
                    "Unsupported MAC Access Authentication encoding error", e);
        } catch (IllegalArgumentException e) {
            getLogger().log(Level.INFO,
                    "Unable to decode the MAC Access Authentication", e);
        }
    }
}
