...
public class OAuth2 {
    ...
    public enum EndpointType {
         ...
         *
         * @see <a href="http://tools.ietf.org/html/draft-ietf-oauth-v2-24#section-3.1">3.1.  Authorization Endpoint</a>
         */
         ...
         *
         * @see <a href="http://tools.ietf.org/html/draft-ietf-oauth-v2-24#section-3.2">3.2.  Token Endpoint</a>
         */
        TOKEN_ENDPOINT,
        /**
         * Extension grant types MAY define additional endpoints as needed.
         *
         * @see <a href="http://tools.ietf.org/html/draft-ietf-oauth-v2-24#section-3">3.  Protocol Endpoints</a>
         */
        OTHER;
    }
...
/*    public static final Set<String> params;
    ...
    static {
        ...
        paramSet.add(Params.ACCESS_TOKEN);
        paramSet.add(Params.CLIENT_ID);
        paramSet.add(Params.CLIENT_SECRET);
        paramSet.add(Params.CODE);
        paramSet.add(Params.ERROR);
        paramSet.add(Params.ERROR_DESCRIPTION);
        paramSet.add(Params.ERROR_URI);
        paramSet.add(Params.EXPIRES_IN);
        paramSet.add(Params.GRANT_TYPE);
        paramSet.add(Params.PASSWORD);
        paramSet.add(Params.REDIRECT_URI);
        paramSet.add(Params.REFRESH_TOKEN);
        paramSet.add(Params.RESPONSE_TYPE);
        paramSet.add(Params.SCOPE);
        paramSet.add(Params.STATE);
        paramSet.add(Params.TOKEN_TYPE);
        paramSet.add(Params.USERNAME);
        params = Collections.unmodifiableSet(paramSet);
    }*/
     ...
     *
     * @see <a href="">11.3.  The OAuth Authorization Endpoint Response Type Registry</a>
     */
    ...
    /**
     * @see <a href="http://tools.ietf.org/html/draft-ietf-oauth-v2-24#section-5.2.1">5.2.1.  The "Bearer" Authentication Scheme</a>
     */
    public class Bearer {
        /**
     ...
     *
     * @see <a href="http://tools.ietf.org/html/draft-ietf-oauth-saml2-bearer">SAML 2.0 Bearer Assertion Profiles for OAuth 2.0</a>
     */
    public class SAML20 {
        /**
        ...
        public static final String CLIENT_ASSERTION_TYPE_URI = "urn:ietf:params:oauth:client-assertion-type:saml2-bearer";
    ...
    /**
     * @see <a href="http://tools.ietf.org/html/draft-ietf-oauth-v2-http-mac"></a>
     */
    public class MAC {
        ...
        /**
         * REQUIRED.  The request timestamp.  The value MUST be a positive integer set by the client when making each
         * request to the number of seconds elapsed from a fixed point in time (e.g. January 1, 1970 00:00:00 GMT).
         * The value MUST NOT include leading zeros (e.g. "000273154346").
         */
        public static final String TS = "ts";
        /**
         * REQUIRED.  A unique string generated by the client.  The value MUST be unique across all requests with
         * the same timestamp and MAC key identifier combination.
         */
        public static final String NONCE = "nonce";
        /**
         * OPTIONAL.  A string used to include additional information which is covered by the request MAC.
         * The content and format of the string is beyond the scope of this specification.
         */
        public static final String EXT = "ext";
        /**
         * REQUIRED.  The HTTP request MAC as described in
         * <a href="http://tools.ietf.org/html/draft-ietf-oauth-v2-http-mac-01#section-3.2">Section 3.2</a>
         */
...
Internet-Draft             MAC Authentication                   May 2011
   ...
   Related information:  None
    ...
    /**
     * See <a href="http://tools.ietf.org/html/draft-ietf-oauth-v2-25#section-11.4">11.4.  The OAuth Extensions Error Registry</a>
     */
    public class Error {
        /**
         * A single error code
        ...
        /**
         * OPTIONAL.  A human-readable UTF-8 encoded text providing additional information, used to assist the
        ...
        /**
         * The access token provided is expired, revoked, malformed, or invalid for other reasons.  The resource
         * SHOULD respond with the HTTP 401 (Unauthorized) status code.  The client MAY request a new access token
         * and retry the protected resource request.
         *
         * @see <a href="http://tools.ietf.org/html/draft-ietf-oauth-v2-bearer-17#section-3.1">Error Codes</a>
         */
        public static final String INVALID_TOKEN = "invalid_token";

        /**
         * The request requires higher privileges than provided by the access token.  The resource server SHOULD
         * respond with the HTTP 403 (Forbidden) status code and MAY include the "scope" attribute with the scope
         ...
         *
         * @see <a href="http://tools.ietf.org/html/draft-ietf-oauth-v2-10#section-5.2.1">5.2.1.  Error Codes</a>
         */
         ...
         *
         * @see <a href="http://tools.ietf.org/html/draft-ietf-oauth-v2-10#section-4.3.1">4.3.1.  Error Codes</a>
         */
         ...
         *
         * @see <a href="http://tools.ietf.org/html/draft-ietf-oauth-v2-10#section-3.2.1">3.2.1.  Error Codes</a>
         */
    ...
    public class Custom {
        /**
         * This parameter indicates whether the user should be prompted to grant account access to your application each time he tries to complete a particular action. The default value is auto, which indicates that a user would only need to grant access the first time he tried to access a protected resource.
         * <p/>
         * Set the parameter value to force to direct the user to a consent page even if he has already granted access to your application for a particular set of scopes."
         */
        ...
        /**
         * The display mode in which to render the dialog. The default is {@code page} on the www subdomain and {@code wap} on the m subdomain.
         * {@code touch}: Used on smartphone mobile devices, like iPhone and Android. Use this for tablets with small screens (i.e., under 7 inches) as well.
         * {@code wap}: Display plain HTML (without JavaScript) on a small screen, such as a Nokia 7500.
